# NOTE:
# Files with no categorization / configurations
...
# INFO:
# Font files
CopyFile /usr/share/fonts/TTF/remixicon.ttf
CopyFile /usr/share/fonts/TTF/remixicons.ttf

# INFO:
# Font others
CreateDir /usr/local/share/fonts

# INFO:
# Icons
AddPackage papirus-icon-theme # Papirus icon theme
AddPackage --foreign ttf-material-design-iconic-font # Material Design Iconic Font is a full suite of material design icons (created and maintained by Google) with additional community-designed and brands icons for easy scalable vector graphics on websites or desktop.
